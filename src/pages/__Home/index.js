...
//   const initialFilterExpenses = () => {
//     for (let i = 0; i < expenses.length; i++) {
//       const createdAt = expenses[i].created_at.split("T")[0];
...
//     for (let i = 0; i < expenses.length; i++) {
//       const createdAt = expenses[i].created_at.split("T")[0];
//       if (!filteredExpenses[createdAt]) {
//         filteredExpenses[createdAt] = [expenses[i]];
//       } else if (!filteredExpenses[createdAt].includes(expenses[i])) {
//         filteredExpenses[createdAt] = [
//           ...filteredExpenses[createdAt],
//           expenses[i],
//         ];
//       }
...
//   const displayFilteredExpenses = (expenses) => {
...
//               <Box sx={{ margin: "5px" }}>{expense.category.name}</Box>
//             </Box>
//           </TableCell>
...
//               </Typography>
//               <Table>
//                 {Object.keys(filteredExpenses).map((each) => (
//                   <>
//                     <TableHead>
//                       <TableRow>
...
//                     </TableHead>
//                     <TableBody>
//                       {displayFilteredExpenses(filteredExpenses[each])}
//                     </TableBody>
//                   </>
//                 ))}
//               </Table>
